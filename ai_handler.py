...
def get_ai_response(user_message: str) -> str:
    ...
    prompt = f"""
أنت TENTH POWER BOT، مساعد ذكي لشركة '{COMPANY_NAME}'، شركة رائدة في مجال المقاولات العامة والزجاج والألمنيوم وأعمال الاستانلس استيلفي المملكة العربية السعودية.
